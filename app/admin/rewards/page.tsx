...
export default function AdminRewardsPage() {
  ...
  return (
    <>
      ...
      <section className="mb-5 rounded-lg border border-white/10 bg-white/[0.04] p-6">
        ...
        <form className="mt-4 grid gap-3" onSubmit={handleCreateReward}>
          <div className="grid gap-3 xl:grid-cols-[1fr_160px_180px_120px]">
            <input
              ...
              className="h-10 rounded-lg border border-white/10 bg-white/[0.06] px-3 text-sm font-normal text-[#F5F5F5] outline-none transition placeholder:text-[#F5F5F5]/35 focus:border-[#D51919] focus:bg-white/[0.09] focus:ring-2 focus:ring-[#D51919]/35"
            />
            <input
              type="number"
              min="0"
            ...
            <input
              ...
              className="h-10 rounded-lg border border-white/10 bg-white/[0.06] px-3 text-sm font-normal text-[#F5F5F5] outline-none transition placeholder:text-[#F5F5F5]/35 focus:border-[#D51919] focus:bg-white/[0.09] focus:ring-2 focus:ring-[#D51919]/35"
            />
            <label className="flex h-10 items-center gap-2 rounded-lg border border-white/10 bg-white/[0.04] px-3 text-sm font-normal text-[#F5F5F5]/70">
              <input
                type="checkbox"
          ...
          <textarea
            ...
            rows={3}
            className="rounded-lg border border-white/10 bg-white/[0.06] px-3 py-3 text-sm font-normal text-[#F5F5F5] outline-none transition placeholder:text-[#F5F5F5]/35 focus:border-[#D51919] focus:bg-white/[0.09] focus:ring-2 focus:ring-[#D51919]/35"
          />
          <button
            type="submit"
            disabled={isCreating}
            className="h-10 rounded-lg bg-[#D51919] px-4 text-sm font-bold text-[#F5F5F5] transition hover:bg-[#b91616] focus:outline-none focus:ring-2 focus:ring-[#D51919] focus:ring-offset-2 focus:ring-offset-[#121212] disabled:cursor-not-allowed disabled:opacity-70 sm:w-fit"
          >
      ...
      <section className="rounded-lg border border-white/10 bg-white/[0.04] p-6">
        {notice ? (
          <p className="mb-4 text-sm font-normal text-[#F5F5F5]/65">
            {notice}
          </p>
        ) : null}
              ...
              return (
                ...
                >
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="mt-3 w-full rounded-lg border border-white/10 bg-white/[0.06] px-3 py-3 text-sm font-normal text-[#F5F5F5] outline-none transition placeholder:text-[#F5F5F5]/35 focus:border-[#D51919] focus:bg-white/[0.09] focus:ring-2 focus:ring-[#D51919]/35"
                  />
                  <div className="mt-3 flex flex-col gap-3 sm:flex-row">
                    <button
                      ...
                      className="h-10 rounded-lg border border-white/10 bg-white/[0.06] px-4 text-sm font-normal text-[#F5F5F5] transition hover:border-[#D51919]/60 hover:bg-[#D51919]/15 focus:outline-none focus:ring-2 focus:ring-[#D51919] focus:ring-offset-2 focus:ring-offset-[#121212] disabled:cursor-not-allowed disabled:opacity-70"
                    >
                    ...
                    <button
                      ...
                      className="h-10 rounded-lg border border-[#D51919]/40 bg-[#D51919]/10 px-4 text-sm font-normal text-[#F5F5F5] transition hover:bg-[#D51919]/20 focus:outline-none focus:ring-2 focus:ring-[#D51919] focus:ring-offset-2 focus:ring-offset-[#121212] disabled:cursor-not-allowed disabled:opacity-70"
                    >
                      Delete
                    </button>
                  </div>
