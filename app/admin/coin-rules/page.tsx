  ...
  return (
    <>
      ...
      <section className="mb-5 rounded-lg border border-[#D51919]/30 bg-[#D51919]/10 p-5">
        ...
        <p className="mt-2 text-sm font-normal leading-6 text-[#F5F5F5]/65">
      ...
      <section className="mb-5 rounded-lg border border-white/10 bg-white/[0.04] p-6">
        ...
        >
          ...
          <button
            type="submit"
            disabled={isCreating}
            className="h-10 rounded-lg bg-[#D51919] px-4 text-sm font-bold text-[#F5F5F5] transition hover:bg-[#b91616] focus:outline-none focus:ring-2 focus:ring-[#D51919] focus:ring-offset-2 focus:ring-offset-[#121212] disabled:cursor-not-allowed disabled:opacity-70"
          >
